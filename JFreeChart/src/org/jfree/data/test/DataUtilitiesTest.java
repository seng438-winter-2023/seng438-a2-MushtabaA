	...
	// Sample Test Case provided by SENG 438 Lab Document
	 ...
	 @Test
		public void calculateColumnTotalEmpty() {
			...
			assertEquals("The column total for empty object should be 0", expectedColumnTotal, actualColumnTotal, .000000001d);
		}
	 
	 // Test a valid data parameter with positive values and positive index and other values in other columns
	 @Test
